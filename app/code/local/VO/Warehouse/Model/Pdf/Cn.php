...
class VO_Warehouse_Model_Pdf_Cn extends VO_Warehouse_Model_Pdf_Pdfhelper
{
	...
	public function getPdf($product = array())
	{
		...
		$page->drawRectangle(1, 1, 288, 125,Zend_Pdf_Page::SHAPE_DRAW_STROKE);
		return $pdf;
	}
}